...
var TaskService = exports.TaskService = function () {
    ...
    var TaskService = _classThis = /** @class */ (function () {
        function TaskService_1(tasksRepository, currencyService) {
            this.tasksRepository = tasksRepository;
            this.currencyService = currencyService;
        }
        TaskService_1.prototype.create = function (createTaskDto) {
            return task_entity_1.Task.create(__assign({}, createTaskDto))
                .then(function (res) {
                return res;
            })
                .catch(function (err) {
        ...
        TaskService_1.prototype.findOne = function (id) {
            return this.tasksRepository.findByPk(id, {
                include: [{ model: item_entity_1.Item, through: { attributes: [] } }],
            });
        };
        TaskService_1.prototype.update = function (id, updateTaskDto) {
            return this.tasksRepository.update(__assign({}, updateTaskDto), {
                where: { id: id },
            });
        };
