...
var common_providers_1 = require("./common.providers");
var CommonModule = exports.CommonModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [axios_1.HttpModule],
            providers: __spreadArray([common_service_1.CommonService, currency_service_1.CurrencyService], common_providers_1.commonProviders, true),
